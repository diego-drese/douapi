...
<div class="note-content"><p class="note-inner-content text-muted"></p><p class="note-inner-content text-muted">{{$news->text_start}}</p></div>
<div class="note-link"><a clicktracking=off href="{{$news->url_dou}}" target="_blank">Notícia na íntegra</a></div>
</div> <hr/> </td></tr>
@endforeach
</table>
