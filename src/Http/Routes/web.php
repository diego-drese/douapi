...
Route::group(['prefix' => $prefix_url, 'middleware' => ['web', 'auth', 'Oka6\Admin\Http\Middleware\MiddlewareAdmin']], function () {
	...
	Route::post('/plans/{id}', 'Oka6\DouApi\Http\Controllers\PlanController@update')->name('douapi.plan.update')->where(['iconAdmin' => 'fas fa-edit', 'parentRouteNameAdmin' => 'douapi.plan.index', 'nameAdmin' => 'Plans Update']);
